...
namespace LootersRivalry.Tiles.Basic
{
    public class UnitController : MonoBehaviour
    {
        ...
        IEnumerator Moving(List<TileEntity> path, Action onCompleted, bool needRot)
        {
           ...
           animator.SetFloat("MotionSpeed", 3);
        ...
        void OnMouseDown()
        {     
            if(isActive != null && !isActive.isCoroutineRunning)
            {
        ...
        IEnumerator OnMouseOver()
        {
            if (Input.GetMouseButtonDown(1) && !team.GetTeamActivityStatus())
            {
                ...
                {                    
                    ...
                    if (!n.isCoroutineRunning && n.team.GetTeamActivityStatus() && n.targets.Contains(this) && n.Equals(isActive))
                    {                        
